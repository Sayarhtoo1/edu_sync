...
abstract class AppLocalizations {
  ...
  /// Option to select all classes in the filter.
  ///
  /// In en, this message translates to:
  /// **'All Classes'**
  String get allClasses;

  /// No description provided for @schoolLocationSettingsTitle.
  ///
  /// In en, this message translates to:
  /// **'School Location Settings'**
  String get schoolLocationSettingsTitle;

  /// No description provided for @markStaffAttendanceTitle.
  ///
  /// In en, this message translates to:
  /// **'Mark Staff Attendance'**
  String get markStaffAttendanceTitle;

  /// No description provided for @selectExamAndSubject.
  ///
  /// In en, this message translates to:
  /// **'Please select an exam and a subject.'**
  String get selectExamAndSubject;
  ...
  /// No description provided for @inputMarks.
  ///
  /// In en, this message translates to:
  /// **'Input Marks'**
  String get inputMarks;
  ...
  /// No description provided for @saveMarks.
  ///
  /// In en, this message translates to:
  /// **'Save Marks'**
  String get saveMarks;

  /// Error message when entered marks exceed maximum marks.
  ///
  /// In en, this message translates to:
  /// **'{studentName} marks cannot exceed {maxMarks}.'**
  ...
  /// No description provided for @editSubjectTitle.
  ///
  /// In en, this message translates to:
  /// **'Edit Subject'**
  ...
  /// No description provided for @addGradeTitle.
  ///
  /// In en, this message translates to:
  /// **'Add Grade'**
  ...
  /// In en, this message translates to:
  /// **'Edit Grade'**
  String get editGradeTitle;

  /// No description provided for @gradeNameLabel.
  ///
  /// In en, this message translates to:
  /// **'Grade Name'**
  String get gradeNameLabel;

  /// No description provided for @minPercentageLabel.
  ///
  /// In en, this message translates to:
  /// **'Min Percentage'**
  String get minPercentageLabel;

  /// No description provided for @maxPercentageLabel.
  ///
  /// In en, this message translates to:
  /// **'Max Percentage'**
  String get maxPercentageLabel;
  ...
  /// No description provided for @manageGradesTitle.
  ///
  /// In en, this message translates to:
  /// **'Manage Grades'**
  String get manageGradesTitle;
  ...
  /// No description provided for @addGradeTooltip.
  ///
  /// In en, this message translates to:
  /// **'Add New Grade'**
  String get addGradeTooltip;

  /// No description provided for @failedToSaveExamError.
  ///
  /// In en, this message translates to:
  /// **'Failed to save exam.'**
  String get failedToSaveExamError;

  /// No description provided for @addExamTitle.
  ///
  /// In en, this message translates to:
  /// **'Add Exam'**
  ...
  /// Label for exam name on the report card.
  ///
  /// In en, this message translates to:
  /// **'Exam Name'**
  String get examNameLabel;

  /// No description provided for @examNameValidator.
  ///
  /// In en, this message translates to:
  /// **'Please enter exam name'**
  String get examNameValidator;

  /// No description provided for @examinerNameLabel.
  ///
  /// In en, this message translates to:
  /// **'Examiner Name'**
  String get examinerNameLabel;

  /// No description provided for @examinerNameValidator.
  ///
  /// In en, this message translates to:
  /// **'Please enter examiner name'**
  String get examinerNameValidator;

  /// No description provided for @manageExamsTitle.
  ///
  /// In en, this message translates to:
  /// **'Manage Exams'**
  String get manageExamsTitle;
  ...
  /// No description provided for @addExamTooltip.
  ///
  /// In en, this message translates to:
  /// **'Add New Exam'**
  String get addExamTooltip;

  /// No description provided for @confirmDeleteExamText.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to delete this exam?'**
  String get confirmDeleteExamText;

  /// No description provided for @errorDeletingExam.
  ///
  /// In en, this message translates to:
  /// **'Error deleting exam.'**
  String get errorDeletingExam;
  ...
  /// No description provided for @studentManagementTitle.
  ///
  /// In en, this message translates to:
  /// **'Student Management'**
  String get studentManagementTitle;

  /// No description provided for @classManagementTitle.
  ///
  /// In en, this message translates to:
  /// **'Class Management'**
  String get classManagementTitle;

  /// No description provided for @timetableManagementTitle.
  ///
  /// In en, this message translates to:
  /// **'Timetable Management'**
  String get timetableManagementTitle;

  /// No description provided for @markSchoolAttendance.
  ///
  /// In en, this message translates to:
  /// **'Mark School Attendance'**
  String get markSchoolAttendance;

  /// No description provided for @manageSchoolLessonPlans.
  ///
  /// In en, this message translates to:
  /// **'Manage School Lesson Plans'**
  String get manageSchoolLessonPlans;
  ...
  /// No description provided for @myTimetableTitle.
  ///
  /// In en, this message translates to:
  /// **'My Timetable'**
  String get myTimetableTitle;

  /// No description provided for @lessonPlansTitle.
  ///
  /// In en, this message translates to:
  /// **'Lesson Plans'**
  String get lessonPlansTitle;

  /// No description provided for @viewStudentsTitle.
  ///
  /// In en, this message translates to:
  /// **'View Students'**
  String get viewStudentsTitle;

  /// No description provided for @eduSyncUser.
  ///
  /// In en, this message translates to:
  /// **'EduSync User'**
  String get eduSyncUser;
  ...
  /// Title for the student report card screen.
  ///
  /// In en, this message translates to:
  /// **'Report Card'**
  String get reportCardTitle;

  /// Message displayed when no report card data is found for a student.
  ///
  /// In en, this message translates to:
  /// **'No report card data available.'**
  String get noReportCardData;

  /// Label for student's name on the report card.
  ///
  /// In en, this message translates to:
  /// **'Student Name'**
  String get studentNameLabel;

  /// Title for the section showing subject-wise performance on the report card.
  ///
  /// In en, this message translates to:
  /// **'Subject-wise Performance'**
  String get subjectWisePerformance;

  /// Label for maximum marks in a subject.
  ///
  /// In en, this message translates to:
  /// **'Max Marks'**
  String get maxMarksLabel;

  /// Label for passing marks in a subject.
  ///
  /// In en, this message translates to:
  /// **'Passing Marks'**
  String get passingMarksLabel;

  /// Label for marks obtained by a student in a subject.
  ///
  /// In en, this message translates to:
  /// **'Marks Obtained'**
  String get marksObtainedLabel;

  /// Status indicating a student has passed a subject or overall.
  ///
  /// In en, this message translates to:
  /// **'Pass'**
  String get passStatus;

  /// Status indicating a student has failed a subject or overall.
  ///
  /// In en, this message translates to:
  /// **'Fail'**
  String get failStatus;

  /// Title for the section showing overall performance summary on the report card.
  ///
  /// In en, this message translates to:
  /// **'Overall Summary'**
  String get overallSummary;

  /// Label for total maximum marks across all subjects.
  ///
  /// In en, this message translates to:
  /// **'Total Max Marks'**
  String get totalMaxMarksLabel;

  /// Label for total marks obtained across all subjects.
  ///
  /// In en, this message translates to:
  /// **'Total Marks Obtained'**
  String get totalMarksObtainedLabel;

  /// Label for overall percentage on the report card.
  ///
  /// In en, this message translates to:
  /// **'Percentage'**
  String get percentageLabel;

  /// Label for overall grade on the report card.
  ///
  /// In en, this message translates to:
  /// **'Overall Grade'**
  String get overallGradeLabel;

  /// Label for overall pass/fail status on the report card.
  ///
  /// In en, this message translates to:
  /// **'Overall Status'**
  String get overallStatusLabel;

  /// Title for the screen to manage subjects within an exam.
  ///
  /// In en, this message translates to:
  /// **'Manage Exam Subjects'**
  String get manageExamSubjectsTitle;

  /// Label for the grade obtained in a subject.
  ///
  /// In en, this message translates to:
  /// **'Grade'**
  String get gradeLabel;

  /// Label for grades in charts.
  ///
  /// In en, this message translates to:
  /// **'Grades'**
  String get grades;

  /// Message displayed when no top students are found.
  ///
  /// In en, this message translates to:
  /// **'No top performing students found.'**
  String get noTopStudents;

  /// Title for the analytics dashboard screen.
  ///
  /// In en, this message translates to:
  /// **'Analytics Dashboard'**
  String get analyticsDashboardTitle;

  /// Tab title for overall performance section.
  ///
  /// In en, this message translates to:
  /// **'Overall Performance'**
  String get overallPerformanceTab;

  /// Tab title for subject analysis section.
  ///
  /// In en, this message translates to:
  /// **'Subject Analysis'**
  String get subjectAnalysisTab;

  /// Tab title for student progress section.
  ///
  /// In en, this message translates to:
  /// **'Student Progress'**
  String get studentProgressTab;

  /// Label for the class filter dropdown.
  ///
  /// In en, this message translates to:
  /// **'Filter by Class'**
  String get filterByClass;

  /// Label for average marks metric.
  ///
  /// In en, this message translates to:
  /// **'Average Marks'**
  String get averageMarks;

  /// Label for pass rate metric.
  ///
  /// In en, this message translates to:
  /// **'Pass Rate'**
  String get passRate;

  /// Title for grade distribution section.
  ///
  /// In en, this message translates to:
  /// **'Grade Distribution'**
  String get gradeDistribution;

  /// Placeholder text for grade distribution chart.
  ///
  /// In en, this message translates to:
  /// **'Grade Distribution Chart Placeholder'**
  String get gradeDistributionChart;

  /// Title for top performing students section.
  ///
  /// In en, this message translates to:
  /// **'Top Performing Students'**
  String get topPerformingStudents;

  /// Placeholder text for top students table.
  ///
  /// In en, this message translates to:
  /// **'Top Students Table Placeholder'**
  String get topStudentsTable;

  /// Title for average marks per subject section.
  ///
  /// In en, this message translates to:
  /// **'Average Marks per Subject'**
  String get averageMarksPerSubject;

  /// Placeholder text for average marks chart.
  ///
  /// In en, this message translates to:
  /// **'Average Marks Chart Placeholder'**
  String get averageMarksChart;

  /// Title for pass/fail rate per subject section.
  ///
  /// In en, this message translates to:
  /// **'Pass/Fail Rate per Subject'**
  String get passFailRatePerSubject;

  /// Placeholder text for pass/fail chart.
  ///
  /// In en, this message translates to:
  /// **'Pass/Fail Chart Placeholder'**
  String get passFailChart;

  /// Message prompting user to select a student for progress view.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @marksPerSubject.
  ///
  /// In en, this message translates to:
  /// **'Marks Per Subject'**
  String get marksPerSubject;

  /// Title for the finance overview screen.
  ///
  /// In en, this message translates to:
  /// **'Finance Overview'**
