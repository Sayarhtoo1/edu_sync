...
class DesktopFeeStructureManagement extends StatelessWidget {
  const DesktopFeeStructureManagement({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
        ...
        const Expanded(child: FeeStructureManagementScreen()),
      ],
      ),
    );
  }
