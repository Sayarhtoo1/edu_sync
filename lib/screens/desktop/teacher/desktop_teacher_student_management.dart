...
class DesktopTeacherStudentManagement extends StatelessWidget {
  const DesktopTeacherStudentManagement({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
        ...
        const Expanded(child: TeacherStudentManagementScreen()),
      ],
      ),
    );
  }
